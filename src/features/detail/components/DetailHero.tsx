					...
					>
							...
							>
								...
								>
									...
									{item.total_tracks > 0 && (
										<>
											<Text>·</Text>
											<Text>{item.total_tracks} tracks</Text>
										</>
									)}
									{item.album_type && (
										<>
						...
						{item.external_url && (
							<a
								...
								onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = '#1DB954'; }}
								onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = 'var(--pressd-text-muted)'; }}
							>
								<FaSpotify />
